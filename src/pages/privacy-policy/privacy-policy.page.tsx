    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          обеспечению безопасности персональных данных, предпринимаемые Steamwallet (далее —
          Оператор).
        </p>
        <p className={styles.text}>
          ...
          <p>
            ...
            веб-сайта https://steamwallet.ru.
          </p>
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          определенному или определяемому Пользователю веб-сайта https://steamwallet.ru.
        </p>
        <p className={styles.text}>
        ...
        <p className={styles.text}>
          2.10. Пользователь — любой посетитель веб-сайта https://steamwallet.ru.
        </p>
        <p className={styles.text}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.table}>
          <div className={styles.tableRow}>
            <div className={styles.tableRowCellLeft}>Цель обработки</div>
            <div>
          ...
          <div className={styles.tableRow}>
            <div className={styles.tableRowCellLeft}>Персональные данные</div>
            <ul>
              <li>имя пользователя в телеграм</li>
              <li>фото профиля</li>
            </ul>
          </div>
          <div className={styles.tableRow}>
            <div className={styles.tableRowCellLeft}>Правовые основания</div>
            <div>
          ...
          <div className={styles.tableRow}>
            <div className={styles.tableRowCellLeft}>Виды обработки персональных данных</div>
            <div>Отправка информационных сообщений в Telegram</div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          электронной почты Оператора help@steamwallet.ru с пометкой «Актуализация персональных
          данных».
        </p>
        <p className={styles.text}>
        ...
        <p className={styles.text}>
          ...
          Оператора help@steamwallet.ru с пометкой «Отзыв согласия на обработку персональных
          данных».
        </p>
        <p className={styles.text}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text} style={{ marginBottom: 0 }}>
          ...
          https://steamwallet.ru/privacy-policy.
        </p>
      </section>
